<template>
  <div
    style="direction: rtl"
    class="tw-p-1 border tw-shadow-md tw-m-1 tw-mt-0 tw-rounded-md"
  >
    <div
    ...
    <n-form ref="addSentence_form" :model="formValue" class="tw-p-1 tw-mt-2">
      <!-- senteneces -->
      <div
        class="tw-flex tw-justify-between tw-items-center tw-p-2 tw-flex-wrap"
      >
      ...
      <div>
        <div
          v-for="(sentence, sentence_i) in formValue.sentences"
          :key="sentence_i"
        ...
        >
          <div class="tw-flex tw-justify-between tw-items-center">
            ...
            <n-button
              v-if="formValue.sentences.length > 1"
              circle
              type="error"
              class="tw-mx-3"
          ...
          <InputWrapper label="عنوان العبارة" :is-required="true">
            <n-form-item
              :show-label="false"
              :path="`sentences[${sentence_i}].category`"
              :rule="{
                type: 'number',
                required: false,
            ...
            >
              <n-select
                v-model:value="sentence.category"
                size="large"
                filterable
                :options="sentencesList.data"
                :loading="sentencesList.loading"
                :disabled="sentencesList.loading"
          ...
          <n-collapse display-directive="show" arrow-placement="right">
            ...
            <n-collapse-item
              v-else
              :title="`عدد الاسئلة ${counter(sentence_i, 1)}`"
              name="1"
              class="!tw-m-0"
            >
              <n-collapse
                title="الاسئلة"
                class="!tw-m-0 quest-accorion"
              ...
              >
                <div class="tw-px-3">
                  ...
                  <draggable
                    :list="formValue.sentences[sentence_i].questions"
                    item-key="drag_id"
                    v-bind="draggableQuestProps"
                    :disabled="answer_dragging"
                    @start="ques_dragging = true"
                  ...
                  >
                    <template #item="{ element: question, index: question_i }">
                      ...
                      >
                        <div
                          class="tw-flex-1 tw-flex tw-items-center tw-justify-between tw-flex-wrap"
                        >
                          <n-avatar size="small" round color="#1D3134">
                            {{ question_i + 1 }}
                          </n-avatar>
                          <span
                            class="tw-text-sm tw-m-auto tw-text-center tw-opacity-90"
                          >
                        ...
                        <div class="tw-flex tw-gap-2">
                          ...
                          <n-button circle @click="question.modal = true">
                            <n-icon :component="PencilOutline" size="large" />
                          </n-button>
                          <n-button
                            v-if="
